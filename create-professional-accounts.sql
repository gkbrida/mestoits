...
-- Note: Ce script nécessite l'utilisation de Supabase Auth Admin API
-- Pour créer les comptes, utilisez l'API Supabase ou le dashboard Supabase
-- Les UUIDs sont générés automatiquement
...
RETURNING id INTO TEMP agence1_id;
...
FROM (SELECT id FROM auth.users WHERE email = 'agence1@mestoits.com' LIMIT 1) AS u;
...
FROM auth.users WHERE email = 'agence2@mestoits.com' LIMIT 1;
...
FROM auth.users WHERE email = 'agence3@mestoits.com' LIMIT 1;
...
FROM auth.users WHERE email = 'agence4@mestoits.com' LIMIT 1;
...
FROM auth.users WHERE email = 'agence5@mestoits.com' LIMIT 1;
...
FROM auth.users WHERE email = 'agent1@mestoits.com' LIMIT 1;
...
FROM auth.users WHERE email = 'agent2@mestoits.com' LIMIT 1;
...
FROM auth.users WHERE email = 'notaire1@mestoits.com' LIMIT 1;
...
FROM auth.users WHERE email = 'macon1@mestoits.com' LIMIT 1;
...
FROM auth.users WHERE email = 'electricien1@mestoits.com' LIMIT 1;
...
FROM auth.users WHERE email = 'artisan1@mestoits.com' LIMIT 1;
...
FROM auth.users WHERE email = 'carreleur1@mestoits.com' LIMIT 1;
...
FROM auth.users WHERE email = 'promoteur1@mestoits.com' LIMIT 1;
...
FROM auth.users WHERE email = 'couvreur1@mestoits.com' LIMIT 1;
...
FROM auth.users WHERE email = 'peintre1@mestoits.com' LIMIT 1;
