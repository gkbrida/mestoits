 ...
 * Usage: node create-admin-account.js <email> <password> <full_name>
 * 
...
if (args.length < 3) {
  console.error('❌ Usage: node create-admin-account.js <email> <password> <full_name>');
  console.error('\nExemple:');
  console.error('  node create-admin-account.js admin@mestoits.com "MonMotDePasse123" "Admin Principal"');
  process.exit(1);
}
