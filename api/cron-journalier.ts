...
/**
 * Cron journalier - S'exécute tous les jours à 8h00 UTC
 * Regroupe tout ce qui doit s'exécuter une fois par jour :
 * - Rappel paiement loyer
 * - Rappel paiement échelonné
 * - Rappel réservation
...
const ENDPOINTS = [
  '/api/cron-rent-payment-reminder',
  '/api/cron-installment-payment-reminder',
  '/api/cron-reservation-reminder',
  '/api/cron-lease-expiration-reminder',
  '/api/cron-lease-auto-renewal',
