-- ============================================
-- MIGRATION: Mise à jour de la clé étrangère property_id de leases pour référencer properties_02
-- Date: 2026-02-04
...
-- 3. Vérification : Afficher les contraintes de la table leases
SELECT
...
WHERE conrelid = 'leases'::regclass
  AND conname = 'leases_property_id_fkey'
ORDER BY conname;
